...
cl = LINETCR.LINE()
#nadya.login(qr=True)
cl.login(token="EpU5E1CWtSjXgc1gqTx6.TulyCEOGfW2uhmaMWN605G./MmUySdYXiub95Wh4D2i50qpzgiIBqU8BhCwIU6DCtQ=")
cl.loginResult()
print "BOKIR -Login Success\n\n=====[Sukses Login]====="
...
╠═════════════════
╠❂͜͡➣ Help ☞ Key
╠❂͜͡➣ Simisimi on off (botchat)
╠❂͜͡➣ Ginfo ☞(Cek info Grup)
╠❂͜͡➣ Creator ☞(Cek editing)
╠❂͜͡➣ Gcreator ☞(Cek pembuat Grup)
╠❂͜͡➣ List grup ☞(cek jumlah room)
╠ ❂͜͡➣ Pict grup: ☞(View Logo grup)
╠❂͜͡➣ Auto join☞(Join otomatis grup)
╠❂͜͡➣ Respon on☞(Jawab jika di Tag)
╠❂͜͡➣ Respon off☞(Matika mode Tag)
╠❂͜͡➣ Responkick on☞(Tag = kick )
╠❂͜͡➣ Responkick off☞(off kick Tag)
╠❂͜͡➣ Ghost↔on☞(Bantuan DARURAT)
╠❂͜͡➣ Contact on off☞(cek kontak)
╠❂͜͡➣ Alwaysread on off ☞(Sllu baca)
╠❂͜͡➣ Sambutan on off ☞(Welcome)
╠❂͜͡➣ Sider:on /off☞(Cyduk cctv)
╠❂͜͡➣ Status (Cek setting mode)
╠❂͜͡➣[Gift/Gift1/2/3/4/5/6/7/8]
╠❂͜͡➣ Tagall , Tag all , Ngtag
╠❂͜͡➣ Cek , Point☞( point read)
╠❂͜͡➣ Cctv , Tes ☞ (Cek sider)
╠❂͜͡➣ Add all ☞(Tambah teman)
╠❂͜͡➣ Invite ☞(Invite via contact)
╠❂͜͡➣ Auto like☞ (yng suka like2)
╠❂͜͡➣ Clone grup ☞(Darurat copy grup)
╠❂͜͡➣ Gn  ☞(Ganti nma grup)
╠❂͜͡➣ Invite creator
╠❂͜͡➣ Invite sukri
╠❂͜͡➣ Bc:  ☞(Broadcast)
╠❂͜͡➣ Setbackup
╠❂͜͡➣ Musik , Musrik ☞(search musik)
╠❂͜͡➣ Mirip @ ☞ (copy profile)
╠❂͜͡➣ Steal cover☞ (Image cover)
╠❂͜͡➣ Steal dp ☞(image Dp )
╠❂͜͡➣ Youtubevideo: ☞(Search video)
╠❂͜͡➣ Welcome to ☞(sambitan)
╠❂͜͡➣ Playstore ☞(search app)
╠❂͜͡➣ Mid @ ☞ (cek mid)
╠❂͜͡➣ Namaku (Ganti namamu)
╠❂͜͡➣ Image (search image)
╠❂͜͡➣ Memblist (Cek list member)
╠❂͜͡➣ Kalender  (Tanggalan)
╠❂͜͡➣ Removechat ⚠(Hapus semua chatmu)
╠❂͜͡➣ Google: (search di mbah gugel)
╠❂͜͡➣ Gruplist (Cek Ur grup)
╠════════════════
╠🔷DONT KLIK IF  U NOT UNDERSTAND🔷
╠════════════════
╠❂͜͡➣ Cancel ☞ (Membatalkan invite)
╠❂͜͡➣ Gurl  ☞⚠(Buka kode qr )
╠❂͜͡➣ [[Qr ↔off on]]☞(open↔qr kode)
╠❂͜͡➣ Speed , Sp ☞(Cek speed bot)
╠❂͜͡➣ #Tendang ☞ (Kick member)
╠❂͜͡➣ #Hajar ☞ (kick by tag)
╠❂͜͡➣ #Tendang all (kick smua member)
╠❂͜͡➣ #EROR☞ ( Line Off Hank)
╠❂͜͡➣ Spam: ☞(Spam text)
╠❂͜͡➣ Aim left , Aim out ☞(keluar grup)
╠❂͜͡➣ Booting ☞(Restart ulang)
╠══════════════════
...
Bots=[mid,'ub542d871ea20170d941cc026c27eb4e6','u0ee4c959d575c325d8b62de7686bdad4']
Creator=["ub542d871ea20170d941cc026c27eb4e6"]
admin=["ub542d871ea20170d941cc026c27eb4e6","ufb484c768b5da9de91722b2cf5a19cd3","u0ee4c959d575c325d8b62de7686bdad4"]
...
def bot(op):
    try:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        cl.sendText(op.param1, "Wakwaw" + "☞ " + nick[0] + " ☜" + "\nKetahuan nginceng\nChat yuk biar rame (-__-)   ")
                                    else:
                                        cl.sendText(op.param1, "Alohaaa" + "☞ " + nick[1] + " ☜" + "\nBetah Banget Jadi Penonton. . .\nSini Gabung Chat (-__-)   ")
                                else:
                                    cl.sendText(op.param1, "Nah ketahuan " + "☞ " + Name + " ☜" + "\nNgapain Kak Ngintip Aja???\nayok chat ")
                        else:
                            cl.sendText(op.param1, "O ow kamu ketahuan " + "☞ " + Name + " ☜" + "Jadi cctv\nSini Temenin Aim chat" + nick[1])
                    else:
                        pass
                except:
                    pass
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Manggil aq ada apa bos@ "+cName,cName + " Ada yang bisa di banting? ( ´▽` )ﾉ",cName + " Kangen Ya","Manggi aku pasti kangen "+cName,"Aim Lagi Off @"+cName, cName + " Oit...da paan","Aim Lagi Sibuk\nJangan Di Tag!! " + cName, "Iya Aim hadir bos " + cName, "Opo bro manggil2  " + cName, "Ada Perlu Apa " + cName + "?","Yes knapa beb @ " + cName + " Jangan Ngetag, mulu ah","Sekali Tag 100c  "+ cName,"2x Tag 500c " + cName]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
                     for mention in mentionees:
                           if mention['M'] in Bots:
                                  cl.sendText(msg.to,ret_)
                                  #msg.contentType = 7
                                  #msg.contentMetadata={'STKID': '24200505',
                                                       #'STKPKGID': '1759910',
                                                       #'STKVER': '10'}
                                  msg.contentType = 7      
        ...
        if op.type == 25:
			...
			cl.sendText(msg.to,"Admin Detected~")
              ...
              if msg.from_ in admin:
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Its my creator (^_^)")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"Sudsh Aktif")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"Nudsh Nonaktif")		    
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to,"Mode Nonaktif")
            ...
            elif msg.text in ["Sambutan on","Sambutan:on"]:
              if msg.from_ in admin:
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in admin:
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"Sider On di Aktifkan")
              ...
              if msg.from_ in admin:
                if msg.to in cctv['point']:
                    ...
                    wait["Sider"] = False
                    cl.sendText(msg.to, "Cek Sider Nonaktif")
                else:
                    cl.sendText(msg.to, "Cek setting dulu")                         
		...
		if wait["Simi"] == True: md+="・✔️ Simisimi : On\n          BEBERAPA MODE DI NON AKTIFKAN UNTUK KEAMANAN"
		else:md+="・❌ Simisimi: Off\n           BBERAPA MODE DI NON AKTIFKAN UNTUK KEAMANAN"
                cl.sendText(msg.to,"╔═════════════════════════\n""║           ☆☞ S T A T U S ☜☆\n""╠═════════════════════════\n"+md+"╚═════════════════════════")
            ...
            elif msg.text in ["Tagall","Tag all","Ngtag"]:
              if msg.from_ in admin:
	    ...
	    elif "Clone grup" in msg.text:
	      if msg.from_ in admin:
		thisgroup = cl.getGroups([msg.to])
		Mids = [contact.mid for contact in thisgroup[0].members]
		mi_d = Mids[:33]
		cl.createGroup("Clone grup", mi_d)
		nlcl.sendText(msg.to,"Success invite member to group")
	        ...
	        if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                   ...
                   for g in gs.members:
                       if _nametarget == g.displayName:
                           targets.append(g.mid)
                   if targets == []:
                       cl.sendText(msg.to, "Tidsk bisa mirip.")
                   else:
                       for target in targets:
                            try:
              ...
              if msg.from_ in admin:
                ...
                cl.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "iya halo juga ..@" +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
